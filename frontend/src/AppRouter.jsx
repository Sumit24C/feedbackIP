...
import { FeedbackForm, FeedbackFormList, StudentDashboard } from './pages/student'
import { AllForms, CreateFeedbackForm, FacultyDashboard, OverallSummary, QuestionSummary } from './pages/faculty'
function AppRouter() {
    return (
        <Routes>
