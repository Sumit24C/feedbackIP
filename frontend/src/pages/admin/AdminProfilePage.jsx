        ...
        <div className="max-w-2xl mx-auto pt-10 px-4 space-y-6">
            ...
            <Card className="shadow-md border-blue-200">
                ...
                <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <ProfileField label="Permission" value={profileInfo?.permission} loading={loading} />
                    <ProfileField label="Institute" value={profileInfo.institute?.name} loading={loading} />
                    <ProfileField label="Institute EmailDomain" value={profileInfo.institute?.emailDomain} loading={loading} />
                    <ProfileField label="Institute code" value={profileInfo.institute?.code} loading={loading} />
                </CardContent>
